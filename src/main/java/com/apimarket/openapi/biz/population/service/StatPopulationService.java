...
public class StatPopulationService {
    ...
    public void uploadStatPopulationTrendSido( String yyyymm)
        ...
        StringBuilder urlBuilder = new StringBuilder("https://kosis.kr/openapi/statisticsData.do?method=getList&apiKey=ZGI2MGQ1NjYxZWI5MzE5ZDkzYjUwOWQ5YThjMjU1ODI=&format=json&jsonVD=Y&userStatsId=patron84/101/DT_1B8000G/2/1/20220910122026&prdSe=M"); /*URL*/
    ...
    public void uploadStatPopulationMoveSido( String yyyymm)
        ...
        StringBuilder urlBuilder = new StringBuilder("https://kosis.kr/openapi/statisticsData.do?method=getList&apiKey=ZGI2MGQ1NjYxZWI5MzE5ZDkzYjUwOWQ5YThjMjU1ODI=&format=json&jsonVD=Y&userStatsId=patron84/101/DT_1B26001_A01/2/1/20220918115243&prdSe=M"); /*URL*/
        urlBuilder.append("&startPrdDe="+yyyymm);
        urlBuilder.append("&endPrdDe="+yyyymm);
        URL url = new URL(urlBuilder.toString());
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
